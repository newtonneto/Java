...
public class ViewUI extends javax.swing.JFrame {
    ...
    private void alterarStatusConta() {
        ...
        if (radio1Operador.isSelected()) {
            retornoCliente = agencia.buscaCliente(nomeTitular);
    ...
    private void transferenciaCorrente() {
        String bancoDestino = text1AreaOperador.getText();
        String agenciaDestino = text2AreaOperador.getText();
        int contaDestino = Integer.parseInt(text3AreaOperador.getText());
        String nomeDestino = text4AreaOperador.getText();
        double valor = Double.parseDouble(text5AreaOperador.getText());
        ...
        if (contaCorrente.getSaldo() - valor >= 0) {
            ...
            if (salvaBancoDestino != null) {
                salvaAgenciaDestino = salvaBancoDestino.buscaAgencia(Integer.parseInt(agenciaDestino));
